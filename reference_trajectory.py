...
def generate_trajectory(x_eq1, x_eq2, u_eq1, u_eq2, smooth_percentage=0, t_f=10, dt=1e-4):
    """
...
def plot_trajectory(x_reference, u_reference, t_f=10, dt=1e-4):
    """
    ...
    for i in range(x_reference.shape[0]):
        ...
        ax.plot(time, x_reference[i, :], linewidth=2)
